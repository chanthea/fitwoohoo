  ...
  renderHeader = () => {
    ...
    return (
      <View style={styles.header}>
        ...
        >
          <Icon style={[styles.fontStyle,{paddingRight : 0}]} name='ios-arrow-back' />
          <NBText style={[styles.fontStyle,{paddingLeft : 0}]}>Back</NBText>
        </NBButton>
        ...
        >
        <NBText style={styles.fontStyle} >Choose</NBText>
        </NBButton>
      </View>
    )
  }
